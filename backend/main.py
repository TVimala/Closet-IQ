...
# Folder where uploaded clothing images will be stored
...
async def upload_clothing(
    ...
    # --------------------------------
    # ANALYZE CLOTHING USING FASHIONCLIP
    # --------------------------------
    ...
    try:
        ...
        # Extract top occasion
        top_occasion = analysis["occasions"][0]["label"]

        # Create wardrobe item with AI attributes
...
@app.get("/api/wardrobe/{item_id}/similar")
